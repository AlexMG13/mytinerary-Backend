...
const { verifyDataUser, verifyDataLogin, verifyDataUserGoogle } = require('../middlewares/verifications')
...
authRouter.post('/registergoogle',verifyDataUserGoogle,hashPassword,register)
